import { Eye, FileInput, FileSearch2, Pencil, Trash2 } from "lucide-react";
import React from "react";
import { formatDateWithDateFns } from "../../common/functions";

export const EmpresaAdminTable = ({
  empresas,
  openModal,
  selectedEmpresa,
  onLimpiarDatos,
        ...
        <tbody>
          {empresas.map((empresa) => (
            ...
            >
              ...
              <td className="px-4 py-2 border border-gray-200">
                {formatDateWithDateFns(empresa.fecha_inicio)}
              </td>
              <td className="px-4 py-2 border border-gray-200">
                {formatDateWithDateFns(empresa.fecha_fin)}
              </td>
              <td className="px-4 py-2 border border-gray-200 hidden">
                {empresa.plan_id}
              </td>
              <td className="px-4 py-2 border border-gray-200">
                {empresa.nombre_plan}
              ...
              <td className="px-4 py-2 border border-gray-200">
                ...
                <button
                  ...
                  onClick={() => onLimpiarDatos(empresa)}
                >
                  <Trash2 />
                </button>
              </td>
