...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <div
                className={` bg-gray-800 text-white w-64 min-h-screen p-4 fixed left-0 top-0 z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "-translate-x-full"
                    } md:translate-x-0`}
            >
                ...
                <h2 className="break-words text-2xl font-semibold mb-6">Hola {user.name}</h2>
                <nav>
