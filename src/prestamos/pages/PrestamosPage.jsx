...
export const PrestamosPage = () => {
    ...
    const handleClientSearch = (e) => {
        ...
        setFilteredClients(clients.filter(client => client.nombre.toLowerCase().includes(search)));
    };
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select
                            {...register('tipo_prestamo', { required: 'Seleccione un tipo de préstamo' })}
                            className="w-full border border-gray-300 rounded-md p-2"
                        >
                        ...
                        {errors.tipo_prestamo && <p className="text-red-500 text-sm">{errors.tipo_prestamo.message}</p>}
                    </div>
                    ...
                    <LabeledInput
                        ...
                        {...register("tasa_interes", { required: 'La tasa de interes es requerido' })}
                    />
                    ...
                    <div>
                        ...
                        <select
                            {...register('frecuencia_pago', { required: 'Seleccione un tipo de préstamo' })}
                            className="w-full border border-gray-300 rounded-md p-2"
                        >
                            <option value="">Seleccione</option>
                        ...
                        {errors.frecuencia_pago && <p className="text-red-500 text-sm">{errors.frecuencia_pago.message}</p>}
                    </div>
                    ...
                    <LabeledInput
                        ...
                        {...register("total_cuotas", { required: 'Las cuotas es requerido' })}
